...
const modbosCmd_t modbusCmdlib[] = {
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000b, 0xab20, 0x0201, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000b, 0xab21, 0x0203, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000b, 0xab22, 0x0202, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x03, 0xc8, MODE_PAGE, 0x000b, 0xab23, 0x020a, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000c, 0xac20, 0x00ab, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x09, 0xc8, MODE_PAGE, 0x000c, 0xac21, 0x01f6, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000c, 0xac2a, 0x0206, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x04, 0xc8, MODE_PAGE, 0x000c, 0xac2b, 0x0213, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000d, 0xad20, 0x01f6, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000d, 0xad21, 0x01fb, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000d, 0xad22, 0x0217, 0x00ff},  //
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x000d, 0xad23, 0x021a, 0x00ff},  //
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x02, 0xc8, MODE_PAGE, 0x00b3, 0xb321, 0x0208, 0x00ff},
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x00b3, 0xb323, 0x0211, 0x00ff},
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PAGE, 0x00b3, 0xb324, 0x020d, 0x00ff},
};
